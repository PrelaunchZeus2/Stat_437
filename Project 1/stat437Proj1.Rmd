...
plot = ggplot(vis, aes(x = gene_19110, y = gene_6280)) + xlab("Gene 19110 Expression") + ylab("Gene 6280 Expression") + theme_bw() + geom_point(aes(shape = Type, color = cluster)) + ggtitle("Clustering results using clusGap to estimate cluster number")
plot
```
...
plot2 = plot(1:n, W, type = "b", xlab = "K", ylab = "W(k)")
plot2
