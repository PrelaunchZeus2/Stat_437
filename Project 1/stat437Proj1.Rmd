...
library(dplyr)
set.seed(123)
gene_data = read.csv('data.csv', row.names = 1)
...
random_columns = sample(colnames(gexp2), 1000)
...
gap = clusGap(fiftygeneset, FUN = kmeans, K.max = 29, B = 200, iter.max = 100)
