...
ds3sd_matrix <- as.matrix(ds3sd[, c("dep_delay", "arr_delay", "distance", "air_time", "month", "carrier")])
tmp = t(ds3sd_mat)
colnames(tmp) = c(carrier_names, ds3sd$month)
ds3sd = t(tmp)

#apply hclust with average linkage
hc.ave = hclust(dist(ds3sd), method="average")

#(i) cut dendrogram to get 3 clusters
flightsample$cluster.i = cutree(hc.ave, k = 3)
hcdata = dendro_data_k(hc.ave, 3)
