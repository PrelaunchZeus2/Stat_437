...
library(ggplot2)
k3plot = ggplot(flights, aes(x = arr_delay, y = dep_delay)) + geom_point(aes(color = k3cluster, shape = carrier)) + theme_bw()
k3plot

k2plot = ggplot(flights, aes(x = arr_delay, y = dep_delay)) + geom_point(aes(color = k2cluster, shape = month)) + theme_bw()
k2plot
```
