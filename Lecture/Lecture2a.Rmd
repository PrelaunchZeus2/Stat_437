...
Annotate adds geometric objects to a plot. But unlike a typical geom functiion, properties of the geometric objects are not mapped from variables of a datafream, instead they are vectors
